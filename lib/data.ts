...
export const events: Event[] = [
  {
    ...
    story:
      "전하지 못한 마음은 머릿속을 맴돌다 결국 향기로만 남곤 합니다. AROME의 '꽃으로 남기는 목소리' 이벤트는 그 실체 없는 감정에 꽃의 얼굴을 빌려주는 시간입니다. 전시장 한쪽에 마련된 12가지 꽃 중, 당신의 마음을 가장 잘 대변하는 꽃 한 송이를 골라보세요. 함께 제공되는 태그 카드에 대상과 짧은 문장을 적어 메시지 월에 직접 꽂아주시면, 그 순간 당신의 감정은 향기로운 기록으로 완성됩니다. 누군가에게는 위로가, 누군가에게는 용기가 될 이 꽃의 벽에 당신의 목소리를 보태주세요.",
  ...
  },
  {
    ...
    story:
      "우리가 누군가를 떠올릴 때, 가장 먼저 기억되는 것은 그 사람의 향기일지도 모릅니다. 이번 이벤트는 뻔한 편지 대신, 당신의 진심이 담긴 향기를 직접 배달해 드리는 특별한 프로그램입니다. AROME의 시그니처 향 6종 중 상대방에게 전하고 싶은 분위기를 선택하고, 정성스럽게 준비된 실링 왁스 봉투에 짧은 메시지를 동봉하세요. 당신이 고른 향기는 전용 센티드 페이퍼(Scented Paper)에 깊게 베어든 채, 정성스러운 패키지에 담겨 그 사람의 문 앞까지 전달됩니다. 직접 말하기 쑥스러운 고백이나 고마움을 향기에 빌려 전해보는 건 어떨까요?",
  ...
  },
  {
    ...
    description: "성수동의 붉은 벽돌 골목 끝, 낡은 건물을 따스한 조명과 꽃으로 가득 채운 AROME의 팝업 전시가 열립니다. 오감을 자극하는 향기 도슨트를 체험해 보세요.",
